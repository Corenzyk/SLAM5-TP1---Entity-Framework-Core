...
public partial class KuczykCorentinSlam5Tp1Context : DbContext
{
    public KuczykCorentinSlam5Tp1Context()
    {
    }

    public KuczykCorentinSlam5Tp1Context(DbContextOptions<KuczykCorentinSlam5Tp1Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Partition>(entity =>
        {
            ...
            entity.HasIndex(e => e.Numstyle, "FK_style_partitions");
            ...
            entity.HasOne(d => d.NumstyleNavigation).WithMany(p => p.Partitions)
                ...
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("FK_style_partitions");
